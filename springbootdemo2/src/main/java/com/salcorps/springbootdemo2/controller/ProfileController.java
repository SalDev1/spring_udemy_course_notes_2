...
import com.salcorps.springbootdemo2.model.Profile;
...
public class ProfileController {
    ...
    public ModelAndView displayProfile(Model model, HttpSession session) {
       ...
       // Fetching the person details of the loggedIn User and showing it to the users.
        Person person = (Person) session.getAttribute("loggedInPerson");
        Profile profile = new Profile();

        // Setting all the person details to the profile.
        ...
        // Adding the pojo object into my profile view.
        // It helps you to display info of each param of the object.
