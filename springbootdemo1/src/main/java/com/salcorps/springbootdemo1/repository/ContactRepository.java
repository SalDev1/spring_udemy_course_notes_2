...
import com.salcorps.springbootdemo1.rowmappers.ContactRowMapper;
...
public class ContactRepository {
    ...
    public ContactRepository(JdbcTemplate jdbcTemplate) {
        // spring boot framework will autoconfigure the jdbctemplate for me.
    ...
    public int updateMsgStatus(int contactId, String status , String updatedBy) {
        ...
        return jdbcTemplate.update(sql, new PreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement ps) throws SQLException {
                // The below code helps you map the params to the ? defined in the sql statement.
