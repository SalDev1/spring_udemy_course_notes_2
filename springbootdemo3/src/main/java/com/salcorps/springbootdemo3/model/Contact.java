package com.salcorps.springbootdemo3.model;
...
@NamedNativeQueries({
        ...
        @NamedNativeQuery(
                ...
                query = "select count(*) as cnt from contact_msg where c.status= :status",
                resultSetMapping = "SqlResultSetMapping.count"
        ),
        @NamedNativeQuery(
                name="Contact.updateMsgStatusNative",
                query="UPDATE contact.msg c SET c.status = ?1 WHERE c.contact_id = ?2"
        )
})
