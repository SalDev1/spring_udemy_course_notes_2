...
import com.salcorps.springbootdemo3.model.Courses;
...
public class AdminController  {
    ...
    // The below method is responsible for adding a new student in the specific class.
    @PostMapping("/addStudent")
    public ModelAndView addStudent(Model model , @ModelAttribute("person") Person person , HttpSession session) {
        ModelAndView modelAndView = new ModelAndView();
        EazyClass eazyClass = (EazyClass)session.getAttribute("eazyClasses");
    ...
    // Deleting a student from a specific class.
    ...
    // Delete a student enrolled to a specific course.
